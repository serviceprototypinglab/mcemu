set title "Combination Calculation Price"
...
set output "combinationsearch-price.pdf"
set datafile separator ","
splot 'combinationsearch.csv' using 1:2:7 title 'Price/best' with lines palette, '' using 1:2:9 title 'Price/first' with lines palette
